...
LABEL_DESC_LDT_C:       Descriptor      0,              LDTBLen-1,      DA_LDT                          ; LDTC
LABEL_DESC_LDT_D:       Descriptor      0,              LDTBLen-1,      DA_LDT                          ; LDTD
LABEL_DESC_TSS_A:       Descriptor      0,              TSSALen-1,      DA_386TSS	                ; TSSA
LABEL_DESC_TSS_B:       Descriptor      0,              TSSBLen-1,      DA_386TSS                       ; TSSB
LABEL_DESC_TSS_C:       Descriptor      0,              TSSBLen-1,      DA_386TSS                       ; TSSC
LABEL_DESC_TSS_D:       Descriptor      0,              TSSBLen-1,      DA_386TSS                       ; TSSD
...
LABEL_LDT_C:
;                                   段基址,         段界限,      属性
LABEL_LDT_DESC_CODE_C:	Descriptor      0,      CodeBLen-1,     DA_C + DA_32	; Code, 32 位
LABEL_LDT_DESC_STACK_C: Descriptor      0,      TopOfStackB,    DA_DRWA | DA_32 ; Stack 
; LDT_C 结束 
LDTBLen		equ	$ - LABEL_LDT_C
...
LABEL_LDT_D:
;                                   段基址,         段界限,      属性
LABEL_LDT_DESC_CODE_D:	Descriptor      0,      CodeBLen-1,     DA_C + DA_32	; Code, 32 位
LABEL_LDT_DESC_STACK_D: Descriptor      0,      TopOfStackB,    DA_DRWA | DA_32 ; Stack 
; LDT_D 结束 
LDTBLen		equ	$ - LABEL_LDT_D
